      ...
      <div className="stats-cards">
        <div className="stat-card revenue-card">
          ...
          <div className="card-content">
            ...
            <span className="stat-label">From all income sources</span>
          </div>
        </div>
      ...
      <div className="revenue-breakdown">
        ...
        <div className="breakdown-grid">
          <div className="breakdown-item">
            <div className="breakdown-icon event-icon">
            ...
            <div className="breakdown-content">
              ...
              <p className="breakdown-amount">LKR {systemData.revenueBreakdown?.eventBookings?.toLocaleString() || 0}</p>
            </div>
          </div>
          
          <div className="breakdown-item">
            <div className="breakdown-icon marketplace-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/>
                <line x1="3" y1="6" x2="21" y2="6"/>
                <path d="M16 10a4 4 0 0 1-8 0"/>
            ...
            <div className="breakdown-content">
              ...
              <p className="breakdown-amount">LKR {systemData.revenueBreakdown?.marketplaceSales?.toLocaleString() || 0}</p>
            </div>
          </div>
          
          <div className="breakdown-item">
            <div className="breakdown-icon artist-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                <circle cx="12" cy="7" r="4"/>
              </svg>
            ...
            <div className="breakdown-content">
              ...
              <p className="breakdown-amount">LKR {systemData.revenueBreakdown?.artistBookings?.toLocaleString() || 0}</p>
            </div>
          </div>
          
          <div className="breakdown-item">
            <div className="breakdown-icon donation-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="breakdown-content">
              <h4>Donations</h4>
              <p className="breakdown-amount">LKR {systemData.revenueBreakdown?.donations?.toLocaleString() || 0}</p>
            </div>
          </div>
        </div>
      </div>
